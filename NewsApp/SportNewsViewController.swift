...
class SportNewsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        sportNewsIsAdded = defaults.bool(forKey: Constant.KeyValue.sports)
        
        view.addSubview(newsTableView)
        
        if sportNewsIsAdded == false {
            addNews(with: "sports")
        }
    ...
    func addNews(with category: String){
        DispatchQueue.main.async {
            self.newsManager.getApiData(forCategory: "sports") { apiData in
        ...
        sportNewsIsAdded = true
        defaults.set(sportNewsIsAdded, forKey: Constant.KeyValue.sports)
    ...
    func deleteNews() {
        ...
        do {
            ...
            let pred = NSPredicate(format: "newsType == %@", "sports")
    ...
    func fetchNews() {
        ...
        let predicate = NSPredicate(format: "newsType == %@","sports")
